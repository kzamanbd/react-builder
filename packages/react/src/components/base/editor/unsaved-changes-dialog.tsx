    ...
    <Dialog open={isOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="p-6">
          ...
          <Dialog.Description className="mt-1 text-center text-gray-600">
            You have unsaved changes that will be lost if you leave.
          </Dialog.Description>
          <div className="mt-4 flex justify-center gap-2">
            <button
              onClick={onCancel}
              className="rounded-sm bg-gray-100 px-4 py-2 text-gray-800 transition-colors duration-150 hover:bg-gray-300"
            >
              No, cancel
            </button>
            <button
              onClick={onConfirm}
              className="bg-danger-600 hover:bg-danger-700 rounded-sm px-4 py-2 text-gray-100 transition-colors duration-150 hover:text-white"
            >
              Yes, leave
            </button>
          </div>
