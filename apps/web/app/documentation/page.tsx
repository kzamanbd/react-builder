  ...
  image: {
    ...
    initialData: { src: '', alt: '' }
          ...
          <div className="flex justify-between">
            <a href="/examples" className="rounded-md bg-blue-600 px-6 py-3 text-white transition-colors hover:bg-blue-700">
              View Examples
            </a>
            <a href="/tutorials" className="rounded-md bg-blue-600 px-6 py-3 text-white transition-colors hover:bg-blue-700">
              Explore Tutorials
            </a>
          </div>
        </div>
